package com.pattern.test.domain;

import com.pattern.test.domain.internal.*;
import com.pattern.test.domain.internal.state.ContainsCoinState;
import com.pattern.test.domain.internal.state.DispensedState;
import com.pattern.test.domain.internal.state.NoCandyState;
import com.pattern.test.domain.internal.state.NoCoinState;

public class CandyMachineService {
    ...
    public CandyMachineService(int numberOfCandies){
